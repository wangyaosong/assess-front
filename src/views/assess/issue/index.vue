<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="考核人员" prop="deptId">
        <treeselect style="width: 10rem" v-model="queryParams.deptId" :options="deptOptions" :show-count="true" placeholder="请选择考核人员" :multiple="true" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="issueList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考核人员名称" align="center" prop="deptName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-input type="hidden" v-model="form.deptName" placeholder="请输入考核人员id" />
        <el-form-item label="考核人员" prop="deptId">
          <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择考核人员" @select="deptChange" :multiple="true"/>
        </el-form-item>
      </el-form>
...
import { userDeptTreeselect  } from "@/api/system/dept";
  ...
  methods: {
    ...
    deptChange(node){
      if (this.isFirst) {
          ...
          this.form.deptName = this.form.deptName+","+node.label;
      }
    },
    issueAssess(row){
      const ids = row.id || this.ids;
